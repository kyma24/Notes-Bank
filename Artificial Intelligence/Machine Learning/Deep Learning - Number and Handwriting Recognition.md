...
print(typed_story)
```
[Link to full explanation](https://colab.research.google.com/drive/1AVjfzCG2HhtxOemOQesc7FeeLZcFBPUZ#scrollTo=fWADSaLh_uho)

Another one:
![[HandwritingRecognitionSystem-master.zip]]